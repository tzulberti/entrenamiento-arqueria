...
var FlechasCrudApplication = FieldCrudApp.$extend({
    ...
    __init__: function(element, historyManager, apiManager, databaseInformation) {
        var formFields = [
            ...
            new FormFieldData('calibre_flechas', 'En el caso de las flechas de carbono es un numer (660). En el caso de las jazz son dos numeros juntos (1913)'),
            new FormFieldData('punta', 'El modelo y peso de la punta. Si es una punta de jazz o Plantinum, entonces es el calibre de la punta (1913)'),
